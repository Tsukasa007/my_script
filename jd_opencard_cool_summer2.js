...
有点随机不好判断一天有多少豆 默认21停 觉得自己牛逼  变量JD_OPENCARD_COOL_SUMMER 就改成999 跑完 算了！！
有点随机不好判断一天有多少豆 默认21停 觉得自己牛逼  变量JD_OPENCARD_COOL_SUMMER 就改成999 跑完 算了！！
有点随机不好判断一天有多少豆 默认21停 觉得自己牛逼  变量JD_OPENCARD_COOL_SUMMER 就改成999 跑完 算了！！
有点随机不好判断一天有多少豆 默认21停 觉得自己牛逼  变量JD_OPENCARD_COOL_SUMMER 就改成999 跑完 算了！！
有点随机不好判断一天有多少豆 默认21停 觉得自己牛逼  变量JD_OPENCARD_COOL_SUMMER 就改成999 跑完 算了！！
...
入口复制到jd：
27.0复制整段话 http:/JWZkxfX17mRnHZ 速来瓜分千万京豆，赢取豪华礼包#a6Mje3Eiyb%祛→【猄〤崬】

更新地址：https://github.com/Tsukasa007/my_script
============Quantumultx===============
[task_local]
#8.5-8.12 大牌联合 冰爽一夏 钜惠送好礼
22 0,4,20 * * * jd_opencard_cool_summer2.js, tag=8.5-8.12 大牌联合 冰爽一夏 钜惠送好礼, img-url=https://raw.githubusercontent.com/tsukasa007/icon/master/jd_opencard_cool_summer2.png, enabled=true

================Loon==============
[Script]
cron "22 0,4,20 * * *" script-path=jd_opencard_cool_summer2.js,tag=8.5-8.12 大牌联合 冰爽一夏 钜惠送好礼

===============Surge=================
8.5-8.12 大牌联合 冰爽一夏 钜惠送好礼 = type=cron,cronexp="22 0,4,20 * * *",wake-system=1,timeout=3600,script-path=jd_opencard_cool_summer2.js
...
!(async () => {
    ...
    $.shareUuid = 'd7509454ec8546a286928b9e47cd0fff'
