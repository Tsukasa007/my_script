...
[task_local]
#汪汪乐园每日任务
20 9,12,14,18 * * * jd_joypark_task.js, tag=汪汪乐园每日任务, img-url=https://raw.githubusercontent.com/tsukasa007/icon/master/jd_joypark_task.png, enabled=true

================Loon==============
[Script]
cron "20 9,12,14,18 * * *" script-path=jd_joypark_task.js,tag=汪汪乐园每日任务

===============Surge=================
汪汪乐园每日任务 = type=cron,cronexp="20 9,12,14,18 * * *",wake-system=1,timeout=3600,script-path=jd_joypark_task.js

============小火箭=========
汪汪乐园每日任务 = type=cron,script-path=jd_joypark_task.js, cronexpr="20 9,12,14,18 * * *", timeout=3600, enable=true
*/
