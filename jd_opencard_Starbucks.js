...
function getDrawRecordHasCoupon() {
    return new Promise(resolve => {
        let body = `activityId=4f1c5009e17a40e58c678cc106369a53&actorUuid=${$.actorUuid}&shareUuid=${$.shareUuid ? $.shareUuid : 'e77ff86e31a64e779216fefbeb307908'}&pin=${encodeURIComponent($.myPingData.secretPin)}`
...
function saveTask() {
    return new Promise(resolve => {
        let body = `activityId=4f1c5009e17a40e58c678cc106369a53&pin=${encodeURIComponent($.myPingData.secretPin)}&taskType=2&taskValue=2736969&actorUuid=${$.actorUuid}&shareUuid=${$.shareUuid ? $.shareUuid : 'e77ff86e31a64e779216fefbeb307908'}`
...
async function startDraw(type) {
    return new Promise(resolve => {
        let body = `activityId=4f1c5009e17a40e58c678cc106369a53&actorUuid=${$.actorUuid}&shareUuid=${$.shareUuid ? $.shareUuid : 'e77ff86e31a64e779216fefbeb307908'}&pin=${encodeURIComponent($.myPingData.secretPin)}&type=${type}`
        $.post(taskPostUrl('/dingzhi/dz/openCard/startDraw', body, `https://lzdz1-isv.isvjcloud.com/dingzhi/dz/openCard/activity/805745?activityId=4f1c5009e17a40e58c678cc106369a53&shareUuid=${$.shareUuid ? $.shareUuid : 'e77ff86e31a64e779216fefbeb307908'}`), async (err, resp, data) => {
            try {
                if (err) {
                    console.log(`${$.name} API请求失败，请检查网路重试`)
                } else {
...
function getHtml() {
    return new Promise(resolve => {
        $.get({
            url: `https://lzdz1-isv.isvjcloud.com/dingzhi/dz/openCard/activity/797702?activityId=4f1c5009e17a40e58c678cc106369a53&shareUuid=${$.shareUuid ? $.shareUuid : 'e77ff86e31a64e779216fefbeb307908'}&adsource=null&shareuserid4minipg=P0CZ6sYjxiDL7YQZAjODCU7oeVP9kq2pYSH90mYt4m3fwcJlClpxrfmVYaGKuquQkdK3rLBQpEQH9V4tdrrh0w==&shopid=1000009621&lng=113.387958&lat=22.511013&sid=09fdc8e908526b5538a4ad4a265f40dw&un_area=19_1657_52093_0`,
            headers: {
...
function taskPostUrl(url, body, referer) {
    return {
        ...
        headers: {
            ...
            "Referer": referer ? referer : `https://lzdz1-isv.isvjcloud.com/lzclient/dz/2021jan/eliminateGame/0713eliminate/?activityId=735c30216dc640638ceb6e63ff6d8b17&shareUuid=${$.shareUuid ? $.shareUuid : 'e77ff86e31a64e779216fefbeb307908'}&adsource=&shareuserid4minipg=u%2FcWHIy7%2Fx3Ij%20HjfbnnePkaL5GGqMTUc8u%2Fotw2E%20a7Ak3lgFoFQlZmf45w8Jzw&shopid=0&lng=114.062541&lat=29.541254&sid=57b59835c68ed8959d124d644f61c58w&un_area=4_48201_54794_0`,
            "User-Agent": UA,
